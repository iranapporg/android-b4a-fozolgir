...
public static String  _changeicon() throws Exception{
 //BA.debugLineNum = 55;BA.debugLine="Sub changeIcon";
 //BA.debugLineNum = 56;BA.debugLine="IconName = preSetting.GetString(\"widgetIcon\")";
_iconname = _presetting.GetString("widgetIcon");
 //BA.debugLineNum = 57;BA.debugLine="If IconName.Length > 0 Then";
if (_iconname.length()>0) { 
 //BA.debugLineNum = 58;BA.debugLine="r1.SetImage(\"img1\",LoadBitmap(File.DirAssets,IconName))";
_r1.SetImage(processBA,"img1",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),_iconname).getObject()));
 //BA.debugLineNum = 59;BA.debugLine="r1.UpdateWidget";
...
public static String  _evnwidget_requestupdate() throws Exception{
 //BA.debugLineNum = 41;BA.debugLine="Sub evnWidget_RequestUpdate";
 //BA.debugLineNum = 42;BA.debugLine="r1.UpdateWidget";
_r1.UpdateWidget(processBA);
 //BA.debugLineNum = 43;BA.debugLine="End Sub";
return "";
}
public static String  _img1_click() throws Exception{
 //BA.debugLineNum = 63;BA.debugLine="Sub img1_Click";
 //BA.debugLineNum = 64;BA.debugLine="timer1.Enabled = False";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 65;BA.debugLine="If IsPaused(cycle) = True Then";
if (anywheresoftware.b4a.keywords.Common.IsPaused(processBA,(Object)(mostCurrent._cycle.getObject()))==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 66;BA.debugLine="StopService(cycle)";
anywheresoftware.b4a.keywords.Common.StopService(processBA,(Object)(mostCurrent._cycle.getObject()));
 //BA.debugLineNum = 67;BA.debugLine="CancelScheduledService(cycle)";
anywheresoftware.b4a.keywords.Common.CancelScheduledService(processBA,(Object)(mostCurrent._cycle.getObject()));
 //BA.debugLineNum = 68;BA.debugLine="ToastMessageShow(\"برنامه غیر فعال شد\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("برنامه غیر فعال شد",anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 70;BA.debugLine="ToastMessageShow(\"khkhkhk\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("khkhkhk",anywheresoftware.b4a.keywords.Common.False);
 };
...
public static String  _screen_screenoff(anywheresoftware.b4a.objects.IntentWrapper _intent) throws Exception{
 //BA.debugLineNum = 26;BA.debugLine="Sub screen_ScreenOff (Intent As Intent)";
 //BA.debugLineNum = 27;BA.debugLine="timer1.Enabled = False";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 28;BA.debugLine="i1 = 1";
_i1 = (int) (1);
 //BA.debugLineNum = 29;BA.debugLine="StopService(cycle)";
anywheresoftware.b4a.keywords.Common.StopService(processBA,(Object)(mostCurrent._cycle.getObject()));
 //BA.debugLineNum = 30;BA.debugLine="CancelScheduledService(cycle)";
anywheresoftware.b4a.keywords.Common.CancelScheduledService(processBA,(Object)(mostCurrent._cycle.getObject()));
 //BA.debugLineNum = 31;BA.debugLine="End Sub";
return "";
}
public static String  _screen_screenon(anywheresoftware.b4a.objects.IntentWrapper _intent) throws Exception{
 //BA.debugLineNum = 21;BA.debugLine="Sub screen_ScreenOn (Intent As Intent)";
...
_changeicon();
 //BA.debugLineNum = 18;BA.debugLine="StartService(handleCall)";
anywheresoftware.b4a.keywords.Common.StartService(processBA,(Object)(mostCurrent._handlecall.getObject()));
...
public static String  _service_start(anywheresoftware.b4a.objects.IntentWrapper _startingintent) throws Exception{
 ...
 //BA.debugLineNum = 46;BA.debugLine="If r1.HandleWidgetEvents(StartingIntent) Then";
...
public static String  _t1_tick() throws Exception{
 //BA.debugLineNum = 33;BA.debugLine="Sub t1_Tick";
 //BA.debugLineNum = 34;BA.debugLine="i1 = i1 + 1";
_i1 = (int) (_i1+1);
 //BA.debugLineNum = 35;BA.debugLine="If i1 = 10 Then";
if (_i1==10) { 
 //BA.debugLineNum = 36;BA.debugLine="timer1.Enabled = False";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 37;BA.debugLine="StartService(cycle)";
