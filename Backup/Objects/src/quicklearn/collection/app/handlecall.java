...
String _z = "";
String _y = "";
 //BA.debugLineNum = 54;BA.debugLine="Sub BroadcastReceiver_OnReceive (Action As String,i As Object)";
 //BA.debugLineNum = 55;BA.debugLine="Try";
try { //BA.debugLineNum = 56;BA.debugLine="Dim i2 As Intent";
_i2 = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 57;BA.debugLine="i2 = i";
_i2.setObject((android.content.Intent)(_i));
 //BA.debugLineNum = 58;BA.debugLine="Dim X As String : X = i2.ExtrasToString";
_x = "";
 //BA.debugLineNum = 58;BA.debugLine="Dim X As String : X = i2.ExtrasToString";
_x = _i2.ExtrasToString();
 //BA.debugLineNum = 59;BA.debugLine="Dim Z As String : Z = X.IndexOf(\"NUMBER=\")";
_z = "";
 //BA.debugLineNum = 59;BA.debugLine="Dim Z As String : Z = X.IndexOf(\"NUMBER=\")";
_z = BA.NumberToString(_x.indexOf("NUMBER="));
 //BA.debugLineNum = 60;BA.debugLine="Dim y As String";
_y = "";
 //BA.debugLineNum = 61;BA.debugLine="y = X.SubString2(Z+7,Z+24)";
_y = _x.substring((int) ((double)(Double.parseDouble(_z))+7),(int) ((double)(Double.parseDouble(_z))+24));
 //BA.debugLineNum = 62;BA.debugLine="y= y.replace(\" \",\"\")";
_y = _y.replace(" ","");
 //BA.debugLineNum = 63;BA.debugLine="y= y.replace(\",\",\"\")";
_y = _y.replace(",","");
 //BA.debugLineNum = 64;BA.debugLine="y= y.replace(\"a\",\"\")";
_y = _y.replace("a","");
 //BA.debugLineNum = 65;BA.debugLine="y= y.replace(\"n\",\"\")";
_y = _y.replace("n","");
 //BA.debugLineNum = 66;BA.debugLine="y= y.replace(\"d\",\"\")";
_y = _y.replace("d","");
 //BA.debugLineNum = 67;BA.debugLine="y= y.replace(\"r\",\"\")";
_y = _y.replace("r","");
 //BA.debugLineNum = 68;BA.debugLine="y= y.replace(\"o\",\"\")";
_y = _y.replace("o","");
 //BA.debugLineNum = 69;BA.debugLine="y= y.replace(\"i\",\"\")";
_y = _y.replace("i","");
 //BA.debugLineNum = 70;BA.debugLine="y= y.replace(\"d\",\"\")";
_y = _y.replace("d","");
 //BA.debugLineNum = 71;BA.debugLine="y= y.replace(\".\",\"\")";
_y = _y.replace(".","");
 //BA.debugLineNum = 72;BA.debugLine="y = y.replace(\"+98\",\"\")";
_y = _y.replace("+98","");
 //BA.debugLineNum = 73;BA.debugLine="y = replaceWord(y)";
_y = _replaceword(_y);
 //BA.debugLineNum = 74;BA.debugLine="p1 = y";
_p1 = _y;
 } 
       catch (Exception e66) {
			processBA.setLastException(e66); //BA.debugLineNum = 76;BA.debugLine="Log(LastException.Message)";
...
Object _telephonyinterface = null;
 //BA.debugLineNum = 100;BA.debugLine="Sub KillCall";
 //BA.debugLineNum = 101;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 102;BA.debugLine="r.Target = r.GetContext";
_r.Target = (Object)(_r.GetContext(processBA));
 //BA.debugLineNum = 103;BA.debugLine="Dim TelephonyManager, TelephonyInterface As Object";
_telephonymanager = new Object();
_telephonyinterface = new Object();
 //BA.debugLineNum = 104;BA.debugLine="TelephonyManager = r.RunMethod2(\"getSystemService\", \"phone\", \"java.lang.String\")";
_telephonymanager = _r.RunMethod2("getSystemService","phone","java.lang.String");
 //BA.debugLineNum = 105;BA.debugLine="r.Target = TelephonyManager";
_r.Target = _telephonymanager;
 //BA.debugLineNum = 106;BA.debugLine="TelephonyInterface = r.RunMethod(\"getITelephony\")";
_telephonyinterface = _r.RunMethod("getITelephony");
 //BA.debugLineNum = 107;BA.debugLine="r.Target = TelephonyInterface";
_r.Target = _telephonyinterface;
 //BA.debugLineNum = 108;BA.debugLine="r.RunMethod(\"endCall\")";
_r.RunMethod("endCall");
 //BA.debugLineNum = 109;BA.debugLine="End Sub";
return "";
}
public static String  _killmes() throws Exception{
 //BA.debugLineNum = 50;BA.debugLine="Sub killMes";
 //BA.debugLineNum = 51;BA.debugLine="KillCall";
_killcall();
...
anywheresoftware.b4a.agraham.threading.Threading _t1 = null;
 //BA.debugLineNum = 44;BA.debugLine="Sub killThread";
 //BA.debugLineNum = 45;BA.debugLine="Dim t1 As Thread";
_t1 = new anywheresoftware.b4a.agraham.threading.Threading();
 //BA.debugLineNum = 46;BA.debugLine="t1.Initialise(\"th\")";
_t1.Initialise(processBA,"th");
 //BA.debugLineNum = 47;BA.debugLine="t1.Start(Me,\"killMes\",Null)";
...
String _pn = "";
 //BA.debugLineNum = 20;BA.debugLine="Sub PSL_onCallStateChanged (State As Int, incomingNumber As String)";
 //BA.debugLineNum = 21;BA.debugLine="Dim pn As String";
_pn = "";
 //BA.debugLineNum = 22;BA.debugLine="pn = preSetting.GetString(\"pn\")";
_pn = _presetting.GetString("pn");
 //BA.debugLineNum = 24;BA.debugLine="If pn.Length = 0 Then";
if (_pn.length()==0) { 
 //BA.debugLineNum = 25;BA.debugLine="pn = \"**98\"";
_pn = "**98";
 };
 //BA.debugLineNum = 28;BA.debugLine="If pn = p1 OR p1 = \"**98\" Then";
if ((_pn).equals(_p1) || (_p1).equals("**98")) { 
 //BA.debugLineNum = 29;BA.debugLine="StartActivity(Main)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._main.getObject()));
 //BA.debugLineNum = 30;BA.debugLine="killThread";
_killthread();
 }else if((_p1).equals("0020")) { 
 //BA.debugLineNum = 32;BA.debugLine="StartService(cycle)";
...
_killthread();
 //BA.debugLineNum = 34;BA.debugLine="ToastMessageShow(\"سرویس فضول یاب فعال شد\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("سرویس فضول یاب فعال شد",anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 36;BA.debugLine="StopService(cycle)";
anywheresoftware.b4a.keywords.Common.StopService(processBA,(Object)(mostCurrent._cycle.getObject()));
 //BA.debugLineNum = 37;BA.debugLine="CancelScheduledService(cycle)";
anywheresoftware.b4a.keywords.Common.CancelScheduledService(processBA,(Object)(mostCurrent._cycle.getObject()));
 //BA.debugLineNum = 38;BA.debugLine="killThread";
_killthread();
 //BA.debugLineNum = 39;BA.debugLine="ToastMessageShow(\"سرویس فضول یاب غیر فعال شد\",False)";
...
String _n1 = "";
int _i = 0;
 //BA.debugLineNum = 80;BA.debugLine="Sub replaceWord(number As String) As String";
 //BA.debugLineNum = 81;BA.debugLine="Dim s1,n1 As String";
_s1 = "";
_n1 = "";
 //BA.debugLineNum = 82;BA.debugLine="n1 = number";
_n1 = _number;
 //BA.debugLineNum = 84;BA.debugLine="For i = 65 To 90";
{
final int step72 = 1;
final int limit72 = (int) (90);
for (_i = (int) (65); (step72 > 0 && _i <= limit72) || (step72 < 0 && _i >= limit72); _i = ((int)(0 + _i + step72))) {
 //BA.debugLineNum = 85;BA.debugLine="s1 = Chr(i)";
_s1 = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(_i));
 //BA.debugLineNum = 86;BA.debugLine="s1 = s1.ToLowerCase";
_s1 = _s1.toLowerCase();
 //BA.debugLineNum = 87;BA.debugLine="n1 = n1.Replace(s1,\"\")";
_n1 = _n1.replace(_s1,"");
 }
};
 //BA.debugLineNum = 89;BA.debugLine="Return n1";
if (true) return _n1;
...
public static String  _service_create() throws Exception{
 ...
 //BA.debugLineNum = 12;BA.debugLine="broadcast.Initialize(\"BroadcastReceiver\")";
_broadcast.Initialize(processBA,"BroadcastReceiver");
 //BA.debugLineNum = 13;BA.debugLine="broadcast.addAction(\"android.intent.action.NEW_OUTGOING_CALL\")";
_broadcast.addAction("android.intent.action.NEW_OUTGOING_CALL");
 //BA.debugLineNum = 14;BA.debugLine="broadcast.SetPriority(2147483647)";
_broadcast.SetPriority((int) (2147483647));
 //BA.debugLineNum = 15;BA.debugLine="broadcast.registerReceiver(\"\")";
_broadcast.registerReceiver("");
 //BA.debugLineNum = 16;BA.debugLine="psl.Initialize(\"PSL\", False)";
_psl.Initialize(processBA,"PSL",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 17;BA.debugLine="psl.startListeningForEvent(psl.LISTEN_CALL_STATE)";
_psl.startListeningForEvent(_psl.LISTEN_CALL_STATE);
 //BA.debugLineNum = 18;BA.debugLine="End Sub";
return "";
}
public static String  _service_destroy() throws Exception{
 //BA.debugLineNum = 96;BA.debugLine="Sub Service_Destroy";
 //BA.debugLineNum = 97;BA.debugLine="broadcast.unregisterReceiver";
