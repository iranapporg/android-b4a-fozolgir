...
public static String  _a1_animationend() throws Exception{
 //BA.debugLineNum = 43;BA.debugLine="Sub a1_AnimationEnd";
 //BA.debugLineNum = 44;BA.debugLine="Panel1.Visible=True";
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 45;BA.debugLine="A2.InitializeAlpha(\"a2\",0,1)";
mostCurrent._a2.InitializeAlpha(mostCurrent.activityBA,"a2",(float) (0),(float) (1));
 //BA.debugLineNum = 46;BA.debugLine="A2.Duration=600";
mostCurrent._a2.setDuration((long) (600));
 //BA.debugLineNum = 47;BA.debugLine="A2.Start(Panel1)";
mostCurrent._a2.Start((android.view.View)(mostCurrent._panel1.getObject()));
 //BA.debugLineNum = 48;BA.debugLine="End Sub";
return "";
}
public static String  _a2_animationend() throws Exception{
 //BA.debugLineNum = 50;BA.debugLine="Sub a2_AnimationEnd";
 //BA.debugLineNum = 51;BA.debugLine="Panel1.Visible=True";
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 52;BA.debugLine="t1.Initialize(\"t1\",1300)";
_t1.Initialize(processBA,"t1",(long) (1300));
...
mostCurrent._activity.LoadLayout("splash",mostCurrent.activityBA);
 //BA.debugLineNum = 28;BA.debugLine="Panel2.Visible=True";
mostCurrent._panel2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 30;BA.debugLine="A1.InitializeAlpha(\"a1\",0,1)";
mostCurrent._a1.InitializeAlpha(mostCurrent.activityBA,"a1",(float) (0),(float) (1));
 //BA.debugLineNum = 31;BA.debugLine="A1.Duration=600";
mostCurrent._a1.setDuration((long) (600));
 //BA.debugLineNum = 32;BA.debugLine="A1.Start(Panel2)";
mostCurrent._a1.Start((android.view.View)(mostCurrent._panel2.getObject()));
 //BA.debugLineNum = 34;BA.debugLine="If File.IsDirectory(File.DirInternal & \"/gallery\",\"\") = False Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(anywheresoftware.b4a.keywords.Common.File.getDirInternal()+"/gallery","")==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 35;BA.debugLine="File.MakeDir(File.DirInternal,\"gallery\")";
...
cycle._process_globals();
 ...
 //BA.debugLineNum = 20;BA.debugLine="Dim A1 As Animation";
mostCurrent._a1 = new anywheresoftware.b4a.objects.AnimationWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Dim A2 As Animation";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 16;BA.debugLine="Dim t1 As Timer";
_t1 = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 17;BA.debugLine="End Sub";
return "";
}
public static String  _t1_tick() throws Exception{
 //BA.debugLineNum = 56;BA.debugLine="Sub t1_Tick";
 //BA.debugLineNum = 57;BA.debugLine="StartService(widget)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._widget.getObject()));
...
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._handlecall.getObject()));
 //BA.debugLineNum = 59;BA.debugLine="StopService(cycle)";
anywheresoftware.b4a.keywords.Common.StopService(mostCurrent.activityBA,(Object)(mostCurrent._cycle.getObject()));
 //BA.debugLineNum = 60;BA.debugLine="CancelScheduledService(cycle)";
anywheresoftware.b4a.keywords.Common.CancelScheduledService(mostCurrent.activityBA,(Object)(mostCurrent._cycle.getObject()));
 //BA.debugLineNum = 61;BA.debugLine="myLibrary.blnRun = True";
mostCurrent._mylibrary._blnrun = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 62;BA.debugLine="t1.Enabled = False";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
