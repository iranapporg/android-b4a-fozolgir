...
Sub AnimationView(View1 As View)
Dim ani As AnimationPlus
ani.InitializeAlpha("",0,1.0)
ani.Duration = 700
...
preSetting.SetString("widgetIcon",IconName)
End Sub

Sub savePhoneNumber(PhoneNumber As String)
preSetting.SetString("pn",PhoneNumber)
End Sub

Sub saveTime(time As String)
preSetting.SetString("time",time)
End Sub
