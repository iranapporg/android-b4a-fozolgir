...
mostCurrent._scrollview1.getPanel().AddView((android.view.View)(_p1.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),_stop,(int) (mostCurrent._scrollview1.getWidth()-15),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 34;BA.debugLine="myLibrary.AnimationView(p1,True,1700)";
mostCurrent._mylibrary._animationview(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_p1.getObject())),anywheresoftware.b4a.keywords.Common.True,(int) (1700));
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 63;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean 'Return True to consume the event";
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 66;BA.debugLine="StartActivity(mainpage)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._mainpage.getObject()));
 //BA.debugLineNum = 67;BA.debugLine="myLibrary.SetAnimation(\"file3\",\"file4\")";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 58;BA.debugLine="If UserClosed = False Then";
...
public static String  _lblexit_down() throws Exception{
 //BA.debugLineNum = 72;BA.debugLine="Sub lblexit_Down";
 //BA.debugLineNum = 73;BA.debugLine="lblexit.TextColor = Colors.RGB(227, 31, 26)";
...
public static String  _lblexit_up() throws Exception{
 //BA.debugLineNum = 76;BA.debugLine="Sub lblexit_Up";
 //BA.debugLineNum = 77;BA.debugLine="lblexit.TextColor = Colors.RGB(227, 91, 26)";
mostCurrent._lblexit.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (227),(int) (91),(int) (26)));
 //BA.debugLineNum = 78;BA.debugLine="StartActivity(mainpage)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._mainpage.getObject()));
 //BA.debugLineNum = 79;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 80;BA.debugLine="myLibrary.SetAnimation(\"file3\",\"file4\")";
mostCurrent._mylibrary._setanimation(mostCurrent.activityBA,"file3","file4");
