...
public static boolean _blnopen = false;
...
flm.b4a.animationplus.AnimationPlusWrapper _ani = null;
 //BA.debugLineNum = 184;BA.debugLine="Sub AnimationView(View1 As View,blnPersist As Boolean,duration As Int)";
 //BA.debugLineNum = 185;BA.debugLine="Dim ani As AnimationPlus";
_ani = new flm.b4a.animationplus.AnimationPlusWrapper();
 //BA.debugLineNum = 186;BA.debugLine="ani.InitializeAlpha(\"ani\",0,1.0)";
_ani.InitializeAlpha(_ba,"ani",(float) (0),(float) (1.0));
 //BA.debugLineNum = 187;BA.debugLine="ani.duration = duration";
_ani.setDuration((long) (_duration));
 //BA.debugLineNum = 188;BA.debugLine="ani.PersistAfter = blnPersist";
...
public static String  _getsetting(anywheresoftware.b4a.BA _ba,String _key) throws Exception{
 //BA.debugLineNum = 216;BA.debugLine="Sub getSetting(key As String)";
 //BA.debugLineNum = 217;BA.debugLine="Return preSetting.GetString(key)";
if (true) return _presetting.GetString(_key);
 //BA.debugLineNum = 218;BA.debugLine="End Sub";
return "";
}
public static String  _getsettingboolean(anywheresoftware.b4a.BA _ba,String _key) throws Exception{
 //BA.debugLineNum = 220;BA.debugLine="Sub getSettingBoolean(key As String)";
 //BA.debugLineNum = 221;BA.debugLine="Return preSetting.GetBoolean(key)";
if (true) return BA.ObjectToString(_presetting.GetBoolean(_key));
...
_image1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_i)+".png").getObject()));
 //BA.debugLineNum = 163;BA.debugLine="AnimationView(image1,True,1700)";
_animationview(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_image1.getObject())),anywheresoftware.b4a.keywords.Common.True,(int) (1700));
...
String _image = "";
 //BA.debugLineNum = 235;BA.debugLine="Sub OpenGallery(filename As String)";
 //BA.debugLineNum = 236;BA.debugLine="Dim iIntent As Intent";
_iintent = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 237;BA.debugLine="Dim Image As String";
_image = "";
 //BA.debugLineNum = 239;BA.debugLine="Image = File.Combine(File.DirDefaultExternal, filename)";
_image = anywheresoftware.b4a.keywords.Common.File.Combine(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),_filename);
 //BA.debugLineNum = 241;BA.debugLine="iIntent.Initialize(iIntent.ACTION_VIEW, \"file:///\" & Image)";
_iintent.Initialize(_iintent.ACTION_VIEW,"file:///"+_image);
 //BA.debugLineNum = 243;BA.debugLine="iIntent.SetType(\"image/jpeg\")";
_iintent.SetType("image/jpeg");
 //BA.debugLineNum = 245;BA.debugLine="StartActivity(iIntent)";
...
_presetting = new anywheresoftware.b4a.objects.preferenceactivity.PreferenceManager();
 //BA.debugLineNum = 3;BA.debugLine="Dim blnOpen As Boolean";
_blnopen = false;
 //BA.debugLineNum = 4;BA.debugLine="End Sub";
return "";
}
public static String  _saveicon(anywheresoftware.b4a.BA _ba,String _iconname) throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Sub saveIcon(IconName As String)";
 //BA.debugLineNum = 201;BA.debugLine="setString(\"widgetIcon\",IconName)";
_setstring(_ba,"widgetIcon",_iconname);
 //BA.debugLineNum = 202;BA.debugLine="End Sub";
return "";
}
public static String  _savephonenumber(anywheresoftware.b4a.BA _ba,String _phonenumber) throws Exception{
 //BA.debugLineNum = 204;BA.debugLine="Sub savePhoneNumber(PhoneNumber As String)";
 //BA.debugLineNum = 205;BA.debugLine="setString(\"pn\",PhoneNumber)";
_setstring(_ba,"pn",_phonenumber);
 //BA.debugLineNum = 206;BA.debugLine="End Sub";
return "";
}
public static String  _saveservice(anywheresoftware.b4a.BA _ba,boolean _state) throws Exception{
 //BA.debugLineNum = 212;BA.debugLine="Sub saveService(state As Boolean)";
 //BA.debugLineNum = 213;BA.debugLine="setBoolean(\"service\",state)";
_setboolean(_ba,"service",_state);
 //BA.debugLineNum = 214;BA.debugLine="End Sub";
return "";
}
public static String  _savetime(anywheresoftware.b4a.BA _ba,String _time) throws Exception{
 //BA.debugLineNum = 208;BA.debugLine="Sub saveTime(time As String)";
 //BA.debugLineNum = 209;BA.debugLine="setString(\"time\",time)";
_setstring(_ba,"time",_time);
...
int _in = 0;
int _out = 0;
 //BA.debugLineNum = 224;BA.debugLine="Sub SetAnimation(InAnimation As String, OutAnimation As String)";
 //BA.debugLineNum = 225;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 226;BA.debugLine="Dim package As String";
_package = "";
 //BA.debugLineNum = 227;BA.debugLine="Dim In, out As Int";
_in = 0;
_out = 0;
 //BA.debugLineNum = 228;BA.debugLine="package = r.GetStaticField(\"anywheresoftware.b4a.BA\", \"packageName\")";
_package = BA.ObjectToString(_r.GetStaticField("anywheresoftware.b4a.BA","packageName"));
 //BA.debugLineNum = 229;BA.debugLine="In = r.GetStaticField(package & \".R$anim\", InAnimation)";
_in = (int)(BA.ObjectToNumber(_r.GetStaticField(_package+".R$anim",_inanimation)));
 //BA.debugLineNum = 230;BA.debugLine="out = r.GetStaticField(package & \".R$anim\", OutAnimation)";
_out = (int)(BA.ObjectToNumber(_r.GetStaticField(_package+".R$anim",_outanimation)));
 //BA.debugLineNum = 231;BA.debugLine="r.Target = r.GetActivity";
_r.Target = (Object)(_r.GetActivity((_ba.processBA == null ? _ba : _ba.processBA)));
 //BA.debugLineNum = 232;BA.debugLine="r.RunMethod4(\"overridePendingTransition\", Array As Object(In, out), Array As String(\"java.lang.int\", \"java.lang.int\"))";
_r.RunMethod4("overridePendingTransition",new Object[]{(Object)(_in),(Object)(_out)},new String[]{"java.lang.int","java.lang.int"});
 //BA.debugLineNum = 233;BA.debugLine="End Sub";
return "";
}
public static String  _setboolean(anywheresoftware.b4a.BA _ba,String _key,boolean _val) throws Exception{
 //BA.debugLineNum = 192;BA.debugLine="Sub setBoolean(key As String,val As Boolean)";
 //BA.debugLineNum = 193;BA.debugLine="preSetting.setBoolean(key,val)";
_presetting.SetBoolean(_key,_val);
 //BA.debugLineNum = 194;BA.debugLine="End Sub";
return "";
}
public static String  _setstring(anywheresoftware.b4a.BA _ba,String _key,String _val) throws Exception{
 //BA.debugLineNum = 196;BA.debugLine="Sub setString(key As String,val As String)";
 //BA.debugLineNum = 197;BA.debugLine="preSetting.setString(key,val)";
_presetting.SetString(_key,_val);
...
String[] _k1 = null;
 //BA.debugLineNum = 248;BA.debugLine="Sub splitHelp As String()";
 //BA.debugLineNum = 249;BA.debugLine="Dim k1() As String";
_k1 = new String[(int) (0)];
java.util.Arrays.fill(_k1,"");
 //BA.debugLineNum = 250;BA.debugLine="k1 = Regex.Split(\"NLine\",File.ReadString(File.DirAssets,\"guide.txt\"))";
_k1 = anywheresoftware.b4a.keywords.Common.Regex.Split("NLine",anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"guide.txt"));
 //BA.debugLineNum = 251;BA.debugLine="Return k1";
if (true) return _k1;
