...
public class icon extends Activity implements B4AActivity{
	public static icon mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "quicklearn.collection.app", "quicklearn.collection.app.icon");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (icon).");
				p.finish();
			}
		}
		if (!includeTitle) {
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "quicklearn.collection.app", "quicklearn.collection.app.icon");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "quicklearn.collection.app.icon", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (icon) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (icon) Resume **");
 ...
 public boolean onOptionsItemSelected(android.view.MenuItem item) {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (icon) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 18;BA.debugLine="Activity.LoadLayout(\"frmicon\")";
mostCurrent._activity.LoadLayout("frmicon",mostCurrent.activityBA);
...
mostCurrent._lblexit.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("icomoon.ttf"));
 //BA.debugLineNum = 21;BA.debugLine="myLibrary.GridPanelIcon(ScrollView1)";
mostCurrent._mylibrary._gridpanelicon(mostCurrent.activityBA,mostCurrent._scrollview1);
 //BA.debugLineNum = 22;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 43;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean 'Return True to consume the event";
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._settings.getObject()));
 //BA.debugLineNum = 47;BA.debugLine="myLibrary.SetAnimation(\"file3\",\"file4\")";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 29;BA.debugLine="If UserClosed = False Then";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 11;BA.debugLine="Private l_title As Label";
...
mostCurrent._label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 14;BA.debugLine="Private lblexit As Button";
...
anywheresoftware.b4a.objects.ImageViewWrapper _i1 = null;
 //BA.debugLineNum = 34;BA.debugLine="Sub Icon_Click";
 //BA.debugLineNum = 35;BA.debugLine="Dim i1 As ImageView";
_i1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 36;BA.debugLine="i1 = Sender";
_i1.setObject((android.widget.ImageView)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 37;BA.debugLine="myLibrary.saveIcon(i1.Tag)";
mostCurrent._mylibrary._saveicon(mostCurrent.activityBA,BA.ObjectToString(_i1.getTag()));
 //BA.debugLineNum = 38;BA.debugLine="myLibrary.AnimationView(i1,True,1700)";
mostCurrent._mylibrary._animationview(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_i1.getObject())),anywheresoftware.b4a.keywords.Common.True,(int) (1700));
 //BA.debugLineNum = 39;BA.debugLine="CallSub(widget,\"changeIcon\")";
anywheresoftware.b4a.keywords.Common.CallSubNew(mostCurrent.activityBA,(Object)(mostCurrent._widget.getObject()),"changeIcon");
 //BA.debugLineNum = 40;BA.debugLine="ToastMessageShow(\"آیکون ویجت صفحه اصلی تغییر یافت\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("آیکون ویجت صفحه اصلی تغییر یافت",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 41;BA.debugLine="End Sub";
return "";
}
public static String  _lblexit_down() throws Exception{
 //BA.debugLineNum = 52;BA.debugLine="Sub lblexit_Down";
 //BA.debugLineNum = 53;BA.debugLine="lblexit.TextColor = Colors.RGB(227, 31, 26)";
...
public static String  _lblexit_up() throws Exception{
 //BA.debugLineNum = 56;BA.debugLine="Sub lblexit_Up";
 //BA.debugLineNum = 57;BA.debugLine="lblexit.TextColor = Colors.RGB(227, 91, 26)";
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 59;BA.debugLine="StartActivity(settings)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._settings.getObject()));
 //BA.debugLineNum = 60;BA.debugLine="myLibrary.SetAnimation(\"file3\",\"file4\")";
mostCurrent._mylibrary._setanimation(mostCurrent.activityBA,"file3","file4");
