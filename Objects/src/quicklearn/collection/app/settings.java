...
mostCurrent._txtval.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (236),(int) (235),(int) (235)));
 //BA.debugLineNum = 53;BA.debugLine="lblmsg.Typeface = font_yekan";
mostCurrent._lblmsg.setTypeface((android.graphics.Typeface)(mostCurrent._font_yekan.getObject()));
 //BA.debugLineNum = 54;BA.debugLine="IME.Initialize(\"\")";
mostCurrent._ime.Initialize("");
 //BA.debugLineNum = 55;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 147;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean 'Return True to consume the event";
 //BA.debugLineNum = 148;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 149;BA.debugLine="If pnloverlay.Visible = True Then";
if (mostCurrent._pnloverlay.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 150;BA.debugLine="checkChange";
_checkchange();
 };
 //BA.debugLineNum = 152;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 153;BA.debugLine="StartActivity(mainpage)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._mainpage.getObject()));
 //BA.debugLineNum = 154;BA.debugLine="myLibrary.SetAnimation(\"file3\",\"file4\")";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 62;BA.debugLine="If UserClosed = False Then";
...
public static String  _btnicon_click() throws Exception{
 //BA.debugLineNum = 67;BA.debugLine="Sub btnicon_Click";
 //BA.debugLineNum = 68;BA.debugLine="StartActivity(icon)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._icon.getObject()));
 //BA.debugLineNum = 69;BA.debugLine="myLibrary.SetAnimation(\"file2\",\"file1\")";
...
public static String  _btnpass_click() throws Exception{
 //BA.debugLineNum = 72;BA.debugLine="Sub btnpass_Click";
 //BA.debugLineNum = 73;BA.debugLine="blnSetting = False";
_blnsetting = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 74;BA.debugLine="txtval.Hint = \"رمز عبور\"";
mostCurrent._txtval.setHint("رمز عبور");
 //BA.debugLineNum = 76;BA.debugLine="If myLibrary.getSetting(\"pn\") <> \"\" Then";
if ((mostCurrent._mylibrary._getsetting(mostCurrent.activityBA,"pn")).equals("") == false) { 
 //BA.debugLineNum = 77;BA.debugLine="txtval.Text = myLibrary.getSetting(\"pn\")";
mostCurrent._txtval.setText((Object)(mostCurrent._mylibrary._getsetting(mostCurrent.activityBA,"pn")));
 //BA.debugLineNum = 78;BA.debugLine="changelogPass = txtval.Text";
mostCurrent._changelogpass = mostCurrent._txtval.getText();
 }else {
 //BA.debugLineNum = 80;BA.debugLine="txtval.Text = \"00\"";
mostCurrent._txtval.setText((Object)("00"));
 //BA.debugLineNum = 81;BA.debugLine="changelogPass = \"00\"";
mostCurrent._changelogpass = "00";
 };
 //BA.debugLineNum = 84;BA.debugLine="lblmsg.Text = \"با رمز بالا ميتوانيد وارد محيط برنامه شويد. در صورت تغيير رمز حتما آنرا به خاطر بسپاريد، در صورت فراموشي به هيچ عنوان نميتوانيد وارد برنامه شويد\"";
mostCurrent._lblmsg.setText((Object)("با رمز بالا ميتوانيد وارد محيط برنامه شويد. در صورت تغيير رمز حتما آنرا به خاطر بسپاريد، در صورت فراموشي به هيچ عنوان نميتوانيد وارد برنامه شويد"));
 //BA.debugLineNum = 85;BA.debugLine="pnloverlay.Visible = True";
mostCurrent._pnloverlay.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 86;BA.debugLine="txtval.RequestFocus";
mostCurrent._txtval.RequestFocus();
 //BA.debugLineNum = 87;BA.debugLine="txtval.SelectAll";
mostCurrent._txtval.SelectAll();
 //BA.debugLineNum = 88;BA.debugLine="IME.ShowKeyboard(txtval)";
mostCurrent._ime.ShowKeyboard((android.view.View)(mostCurrent._txtval.getObject()));
 //BA.debugLineNum = 89;BA.debugLine="blnPass = True";
_blnpass = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 90;BA.debugLine="End Sub";
return "";
}
public static String  _btntime_click() throws Exception{
 //BA.debugLineNum = 92;BA.debugLine="Sub btntime_Click";
 //BA.debugLineNum = 93;BA.debugLine="blnSetting = True";
_blnsetting = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 94;BA.debugLine="txtval.Hint = \"فاصله زمانی\"";
mostCurrent._txtval.setHint("فاصله زمانی");
 //BA.debugLineNum = 96;BA.debugLine="If myLibrary.getSetting(\"time\") <> \"\" Then";
if ((mostCurrent._mylibrary._getsetting(mostCurrent.activityBA,"time")).equals("") == false) { 
 //BA.debugLineNum = 97;BA.debugLine="txtval.Text = myLibrary.getSetting(\"time\")";
mostCurrent._txtval.setText((Object)(mostCurrent._mylibrary._getsetting(mostCurrent.activityBA,"time")));
 //BA.debugLineNum = 98;BA.debugLine="changelogTime = txtval.Text";
mostCurrent._changelogtime = mostCurrent._txtval.getText();
 }else {
 //BA.debugLineNum = 100;BA.debugLine="txtval.Text = 1";
mostCurrent._txtval.setText((Object)(1));
 //BA.debugLineNum = 101;BA.debugLine="changelogTime = 1";
mostCurrent._changelogtime = BA.NumberToString(1);
 };
 //BA.debugLineNum = 104;BA.debugLine="lblmsg.Text = \"زمانی را به عنوان فاصله بین عکس گرفتن وارد کنید. مثلا اگر 5 را بنویسید برنامه هر 5 دقیقه یکبار از فضول گوشیتون عکس میگیرد\"";
mostCurrent._lblmsg.setText((Object)("زمانی را به عنوان فاصله بین عکس گرفتن وارد کنید. مثلا اگر 5 را بنویسید برنامه هر 5 دقیقه یکبار از فضول گوشیتون عکس میگیرد"));
 //BA.debugLineNum = 105;BA.debugLine="pnloverlay.Visible = True";
mostCurrent._pnloverlay.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 106;BA.debugLine="txtval.RequestFocus";
mostCurrent._txtval.RequestFocus();
 //BA.debugLineNum = 107;BA.debugLine="txtval.SelectAll";
mostCurrent._txtval.SelectAll();
 //BA.debugLineNum = 108;BA.debugLine="IME.ShowKeyboard(txtval)";
mostCurrent._ime.ShowKeyboard((android.view.View)(mostCurrent._txtval.getObject()));
 //BA.debugLineNum = 109;BA.debugLine="blnPass = False";
_blnpass = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 110;BA.debugLine="End Sub";
return "";
}
public static String  _btnverify_click() throws Exception{
 //BA.debugLineNum = 112;BA.debugLine="Sub btnverify_Click";
 //BA.debugLineNum = 113;BA.debugLine="If blnSetting = False Then";
if (_blnsetting==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 114;BA.debugLine="changePassword";
_changepassword();
 }else {
 //BA.debugLineNum = 116;BA.debugLine="changeTime";
_changetime();
 };
 //BA.debugLineNum = 118;BA.debugLine="pnloverlay.Visible = False";
mostCurrent._pnloverlay.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 119;BA.debugLine="txtval.Text = \"\"";
mostCurrent._txtval.setText((Object)(""));
 //BA.debugLineNum = 120;BA.debugLine="IME.HideKeyboard";
mostCurrent._ime.HideKeyboard(mostCurrent.activityBA);
 //BA.debugLineNum = 121;BA.debugLine="End Sub";
return "";
}
public static String  _changepassword() throws Exception{
 //BA.debugLineNum = 135;BA.debugLine="Sub changePassword";
 //BA.debugLineNum = 137;BA.debugLine="If txtval.Text.Length < 1 Then";
if (mostCurrent._txtval.getText().length()<1) { 
 //BA.debugLineNum = 138;BA.debugLine="ToastMessageShow(\"خطا: لطفا رمز عبور را وارد کنید\",False)";
...
if (true) return "";
 ...
 //BA.debugLineNum = 142;BA.debugLine="myLibrary.savePhoneNumber(txtval.Text)";
mostCurrent._mylibrary._savephonenumber(mostCurrent.activityBA,mostCurrent._txtval.getText());
 //BA.debugLineNum = 143;BA.debugLine="ToastMessageShow(\"رمز عبور اجرای برنامه با موفقیت تغییر داده شد\",False)";
...
public static String  _changetime() throws Exception{
 //BA.debugLineNum = 123;BA.debugLine="Sub changeTime";
 //BA.debugLineNum = 125;BA.debugLine="If IsNumber(txtval.Text) = False Then";
if (anywheresoftware.b4a.keywords.Common.IsNumber(mostCurrent._txtval.getText())==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 126;BA.debugLine="ToastMessageShow(\"خطا: لطفا فاصله زمانی را به دقیقه و درست وارد کنید\",False)";
...
if (true) return "";
 ...
 //BA.debugLineNum = 130;BA.debugLine="myLibrary.saveTime(txtval.Text)";
mostCurrent._mylibrary._savetime(mostCurrent.activityBA,mostCurrent._txtval.getText());
 //BA.debugLineNum = 131;BA.debugLine="ToastMessageShow(\"فاصله زمانی تعین شده تغیر یافت\",False)";
...
public static String  _checkchange() throws Exception{
 //BA.debugLineNum = 159;BA.debugLine="Sub checkChange";
 //BA.debugLineNum = 160;BA.debugLine="If blnPass = True Then";
if (_blnpass==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 161;BA.debugLine="If changelogPass <> txtval.Text Then";
if ((mostCurrent._changelogpass).equals(mostCurrent._txtval.getText()) == false) { 
 //BA.debugLineNum = 162;BA.debugLine="If Msgbox2(\"آیا رمز عبور جدید ذخیره شود؟\",\"توجه\",\"آری\",\"خیر\",\"\",Null) = DialogResponse.POSITIVE Then";
if (anywheresoftware.b4a.keywords.Common.Msgbox2("آیا رمز عبور جدید ذخیره شود؟","توجه","آری","خیر","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA)==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 163;BA.debugLine="changePassword";
_changepassword();
 };
 };
 }else if(_blnpass==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 167;BA.debugLine="If changelogTime <> txtval.Text Then";
if ((mostCurrent._changelogtime).equals(mostCurrent._txtval.getText()) == false) { 
 //BA.debugLineNum = 168;BA.debugLine="If Msgbox2(\"آیا فاصله زمانی جدید ذخیره شود؟\",\"توجه\",\"آری\",\"خیر\",\"\",Null) = DialogResponse.POSITIVE Then";
if (anywheresoftware.b4a.keywords.Common.Msgbox2("آیا فاصله زمانی جدید ذخیره شود؟","توجه","آری","خیر","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA)==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 169;BA.debugLine="changeTime";
_changetime();
 };
 };
 };
...
public static String  _lblexit_down() throws Exception{
 //BA.debugLineNum = 175;BA.debugLine="Sub lblexit_Down";
 //BA.debugLineNum = 176;BA.debugLine="lblexit.TextColor = Colors.RGB(227, 31, 26)";
...
public static String  _lblexit_up() throws Exception{
 //BA.debugLineNum = 179;BA.debugLine="Sub lblexit_Up";
 //BA.debugLineNum = 180;BA.debugLine="lblexit.TextColor = Colors.RGB(227, 91, 26)";
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 182;BA.debugLine="StartActivity(mainpage)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._mainpage.getObject()));
 //BA.debugLineNum = 183;BA.debugLine="myLibrary.SetAnimation(\"file3\",\"file4\")";
mostCurrent._mylibrary._setanimation(mostCurrent.activityBA,"file3","file4");
 //BA.debugLineNum = 184;BA.debugLine="End Sub";
return "";
}
public static String  _pnloverlay_click() throws Exception{
 //BA.debugLineNum = 186;BA.debugLine="Sub pnloverlay_Click";
 //BA.debugLineNum = 187;BA.debugLine="pnloverlay.Visible = False";
mostCurrent._pnloverlay.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 188;BA.debugLine="IME.HideKeyboard";
mostCurrent._ime.HideKeyboard(mostCurrent.activityBA);
