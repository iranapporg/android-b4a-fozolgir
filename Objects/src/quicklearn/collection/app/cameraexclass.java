...
public class cameraexclass extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "quicklearn.collection.app.cameraexclass");
            if (htSubs == null) {
                ba.loadHtSubs(this.getClass());
                htSubs = ba.htSubs;
            }
            if (BA.isShellModeRuntimeCheck(ba)) {
			    ba.raiseEvent2(null, true, "CREATE", true, "quicklearn.collection.app.cameraexclass",
                    ba);
                return;
		    }
        }
...
public quicklearn.collection.app.cameraexclass._camerainfoandid  _findcamera(boolean _frontcamera) throws Exception{
quicklearn.collection.app.cameraexclass._camerainfoandid _ci = null;
...
_ci = new quicklearn.collection.app.cameraexclass._camerainfoandid();
...
public quicklearn.collection.app.cameraexclass._camerasize  _getpicturesize() throws Exception{
quicklearn.collection.app.cameraexclass._camerasize _cs = null;
...
_cs = new quicklearn.collection.app.cameraexclass._camerasize();
...
public quicklearn.collection.app.cameraexclass._camerasize  _getpreviewsize() throws Exception{
quicklearn.collection.app.cameraexclass._camerasize _cs = null;
...
public quicklearn.collection.app.cameraexclass._camerasize[]  _getsupportedpicturessizes() throws Exception{
...
_cs = new quicklearn.collection.app.cameraexclass._camerasize[_list1.getSize()];
{
int d0 = _cs.length;
for (int i0 = 0;i0 < d0;i0++) {
_cs[i0] = new quicklearn.collection.app.cameraexclass._camerasize();
}
}
;
