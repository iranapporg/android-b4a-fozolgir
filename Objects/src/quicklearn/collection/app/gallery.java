...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 23;BA.debugLine="Activity.LoadLayout(\"frmgallery\")";
mostCurrent._activity.LoadLayout("frmgallery",mostCurrent.activityBA);
 //BA.debugLineNum = 24;BA.debugLine="files = getFiles";
mostCurrent._files = _getfiles();
 //BA.debugLineNum = 26;BA.debugLine="Try";
try { //BA.debugLineNum = 27;BA.debugLine="If files.Size = 0 Then";
if (mostCurrent._files.getSize()==0) { 
 //BA.debugLineNum = 28;BA.debugLine="btndelete.Visible = False";
mostCurrent._btndelete.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 } 
       catch (Exception e19) {
			processBA.setLastException(e19); };
 //BA.debugLineNum = 33;BA.debugLine="l_title.Typeface = Typeface.LoadFromAssets(\"BYekan.ttf\")";
mostCurrent._l_title.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("BYekan.ttf"));
 //BA.debugLineNum = 34;BA.debugLine="btndelete.Typeface = Typeface.LoadFromAssets(\"BYekan.ttf\")";
mostCurrent._btndelete.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("BYekan.ttf"));
 //BA.debugLineNum = 35;BA.debugLine="lblexit.Typeface=Typeface.LoadFromAssets(\"icomoon.ttf\")";
mostCurrent._lblexit.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("icomoon.ttf"));
 //BA.debugLineNum = 36;BA.debugLine="loadImage";
_loadimage();
 //BA.debugLineNum = 37;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 113;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean 'Return True to consume the event";
 //BA.debugLineNum = 114;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 115;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 116;BA.debugLine="StartActivity(mainpage)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._mainpage.getObject()));
 //BA.debugLineNum = 117;BA.debugLine="myLibrary.SetAnimation(\"file3\",\"file4\")";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 85;BA.debugLine="If UserClosed = False Then";
...
int _i = 0;
 //BA.debugLineNum = 133;BA.debugLine="Sub btndelete_Click";
 //BA.debugLineNum = 134;BA.debugLine="If Msgbox2(\"آیا مایل به حذف همه تصاویر هستید؟\",\"توجه\",\"آری\",\"خیر\",\"\",Null)	 = DialogResponse.POSITIVE Then";
if (anywheresoftware.b4a.keywords.Common.Msgbox2("آیا مایل به حذف همه تصاویر هستید؟","توجه","آری","خیر","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA)==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 135;BA.debugLine="Dim l1 As List";
...
try { //BA.debugLineNum = 138;BA.debugLine="l1 = File.ListFiles(File.DirInternal & \"/gallery\")";
_l1 = anywheresoftware.b4a.keywords.Common.File.ListFiles(anywheresoftware.b4a.keywords.Common.File.getDirInternal()+"/gallery");
 //BA.debugLineNum = 139;BA.debugLine="For i = 0 To l1.Size - 1";
{
final int step113 = 1;
final int limit113 = (int) (_l1.getSize()-1);
for (_i = (int) (0); (step113 > 0 && _i <= limit113) || (step113 < 0 && _i >= limit113); _i = ((int)(0 + _i + step113))) {
 //BA.debugLineNum = 140;BA.debugLine="File.Delete(File.DirInternal & \"/gallery\",l1.Get(i))";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirInternal()+"/gallery",BA.ObjectToString(_l1.Get(_i)));
 ...
 //BA.debugLineNum = 142;BA.debugLine="loadImage";
_loadimage();
 //BA.debugLineNum = 143;BA.debugLine="ToastMessageShow(\"همه تصاویر گالری حذف شدند\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("همه تصاویر گالری حذف شدند",anywheresoftware.b4a.keywords.Common.False);
			...
			processBA.setLastException(e119); };
 };
 //BA.debugLineNum = 147;BA.debugLine="End Sub";
return "";
}
public static anywheresoftware.b4a.objects.collections.List  _getfiles() throws Exception{
 //BA.debugLineNum = 39;BA.debugLine="Sub getFiles As List";
 //BA.debugLineNum = 40;BA.debugLine="Try";
try { //BA.debugLineNum = 41;BA.debugLine="Return File.ListFiles(galleryPath)";
if (true) return anywheresoftware.b4a.keywords.Common.File.ListFiles(mostCurrent._gallerypath);
 } 
       catch (Exception e29) {
			processBA.setLastException(e29); //BA.debugLineNum = 43;BA.debugLine="File.MakeDir(File.DirInternal , \"gallery\")";
anywheresoftware.b4a.keywords.Common.File.MakeDir(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"gallery");
 //BA.debugLineNum = 44;BA.debugLine="Return Null";
...
mostCurrent._btndelete = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Dim files      As List";
...
com.rootsoft.rspopupmenu.RSPopupMenu _rs = null;
 //BA.debugLineNum = 90;BA.debugLine="Sub Icon_Click";
 //BA.debugLineNum = 91;BA.debugLine="Dim i1 As ImageView";
_i1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 92;BA.debugLine="i1 = Sender";
_i1.setObject((android.widget.ImageView)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 93;BA.debugLine="currentPicture = i1";
mostCurrent._currentpicture = _i1;
 //BA.debugLineNum = 95;BA.debugLine="Dim rs As RSPopupMenu";
_rs = new com.rootsoft.rspopupmenu.RSPopupMenu();
 //BA.debugLineNum = 96;BA.debugLine="rs.Initialize(\"rs\",i1)";
_rs.Initialize(mostCurrent.activityBA,"rs",(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_i1.getObject())));
 //BA.debugLineNum = 97;BA.debugLine="rs.AddMenuItem(0,1,\"مشاهده\")";
_rs.AddMenuItem((int) (0),(int) (1),"مشاهده");
 //BA.debugLineNum = 98;BA.debugLine="rs.AddMenuItem(1,2,\"حذف\")";
_rs.AddMenuItem((int) (1),(int) (2),"حذف");
 //BA.debugLineNum = 99;BA.debugLine="rs.Show";
_rs.Show();
 //BA.debugLineNum = 100;BA.debugLine="End Sub";
return "";
}
public static String  _lblexit_down() throws Exception{
 //BA.debugLineNum = 122;BA.debugLine="Sub lblexit_Down";
 //BA.debugLineNum = 123;BA.debugLine="lblexit.TextColor = Colors.RGB(227, 31, 26)";
...
public static String  _lblexit_up() throws Exception{
 //BA.debugLineNum = 126;BA.debugLine="Sub lblexit_Up";
 //BA.debugLineNum = 127;BA.debugLine="lblexit.TextColor = Colors.RGB(227, 91, 26)";
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 129;BA.debugLine="StartActivity(mainpage)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._mainpage.getObject()));
 //BA.debugLineNum = 130;BA.debugLine="myLibrary.SetAnimation(\"file3\",\"file4\")";
mostCurrent._mylibrary._setanimation(mostCurrent.activityBA,"file3","file4");
...
anywheresoftware.b4a.objects.ImageViewWrapper _image1 = null;
 //BA.debugLineNum = 48;BA.debugLine="Sub loadImage";
 //BA.debugLineNum = 49;BA.debugLine="Dim divid      As Int = 45%x";
_divid = anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (45),mostCurrent.activityBA);
 //BA.debugLineNum = 50;BA.debugLine="Dim sTop       As Int : sTop       = 6dip";
_stop = 0;
 //BA.debugLineNum = 50;BA.debugLine="Dim sTop       As Int : sTop       = 6dip";
_stop = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (6));
 //BA.debugLineNum = 51;BA.debugLine="Dim sLeft      As Int : sLeft      = 13dip";
_sleft = 0;
 //BA.debugLineNum = 51;BA.debugLine="Dim sLeft      As Int : sLeft      = 13dip";
_sleft = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (13));
 //BA.debugLineNum = 52;BA.debugLine="Dim rip        As RippleView";
_rip = new anywheresoftware.b4a.object.RippleViewWrapper();
 //BA.debugLineNum = 54;BA.debugLine="ScrollView1.Panel.RemoveAllViews";
mostCurrent._scrollview1.getPanel().RemoveAllViews();
 //BA.debugLineNum = 56;BA.debugLine="Try";
try { //BA.debugLineNum = 57;BA.debugLine="For i = 0 To files.Size - 1";
{
final int step42 = 1;
final int limit42 = (int) (mostCurrent._files.getSize()-1);
for (_i = (int) (0); (step42 > 0 && _i <= limit42) || (step42 < 0 && _i >= limit42); _i = ((int)(0 + _i + step42))) {
 //BA.debugLineNum = 58;BA.debugLine="Dim image1 As ImageView";
_image1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 59;BA.debugLine="image1.Initialize(\"Icon\")";
_image1.Initialize(mostCurrent.activityBA,"Icon");
 //BA.debugLineNum = 60;BA.debugLine="ScrollView1.Panel.AddView(image1,sLeft,sTop,divid,divid)";
mostCurrent._scrollview1.getPanel().AddView((android.view.View)(_image1.getObject()),_sleft,_stop,_divid,_divid);
 //BA.debugLineNum = 61;BA.debugLine="rip.Initialize(image1,Colors.RGB(100,221,23),430,True)";
_rip.Initialize(mostCurrent.activityBA,(android.view.View)(_image1.getObject()),anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (100),(int) (221),(int) (23)),(int) (430),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 62;BA.debugLine="image1.Gravity = Gravity.FILL";
_image1.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 63;BA.debugLine="image1.Tag =  files.Get(i)";
_image1.setTag(mostCurrent._files.Get(_i));
 //BA.debugLineNum = 64;BA.debugLine="image1.SetBackgroundImage(LoadBitmapSample(galleryPath, files.Get(i),45%x,45%x))";
_image1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapSample(mostCurrent._gallerypath,BA.ObjectToString(mostCurrent._files.Get(_i)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (45),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (45),mostCurrent.activityBA)).getObject()));
 //BA.debugLineNum = 65;BA.debugLine="myLibrary.AnimationView(image1,True,700)";
mostCurrent._mylibrary._animationview(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_image1.getObject())),anywheresoftware.b4a.keywords.Common.True,(int) (700));
 //BA.debugLineNum = 66;BA.debugLine="DoEvents";
anywheresoftware.b4a.keywords.Common.DoEvents();
 //BA.debugLineNum = 67;BA.debugLine="If (i+1) Mod 2 = 0 Then";
if ((_i+1)%2==0) { 
 //BA.debugLineNum = 68;BA.debugLine="sLeft = 13dip";
_sleft = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (13));
 //BA.debugLineNum = 69;BA.debugLine="sTop = sTop + divid + 10dip";
_stop = (int) (_stop+_divid+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)));
 //BA.debugLineNum = 70;BA.debugLine="ScrollView1.Panel.Height = ScrollView1.Panel.Height + image1.Height + 10dip";
mostCurrent._scrollview1.getPanel().setHeight((int) (mostCurrent._scrollview1.getPanel().getHeight()+_image1.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))));
 ...
 //BA.debugLineNum = 72;BA.debugLine="sLeft = sLeft + divid + 8dip";
...
public static boolean  _rs_menuitemclick(int _itemid) throws Exception{
 //BA.debugLineNum = 102;BA.debugLine="Sub rs_MenuItemClick (ItemId As Int) As Boolean";
 //BA.debugLineNum = 103;BA.debugLine="If (ItemId = 0) Then";
if ((_itemid==0)) { 
 //BA.debugLineNum = 104;BA.debugLine="File.Copy(galleryPath,currentPicture.Tag,File.DirDefaultExternal,currentPicture.Tag)";
anywheresoftware.b4a.keywords.Common.File.Copy(mostCurrent._gallerypath,BA.ObjectToString(mostCurrent._currentpicture.getTag()),anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),BA.ObjectToString(mostCurrent._currentpicture.getTag()));
 //BA.debugLineNum = 105;BA.debugLine="myLibrary.OpenGallery(currentPicture.Tag)";
mostCurrent._mylibrary._opengallery(mostCurrent.activityBA,BA.ObjectToString(mostCurrent._currentpicture.getTag()));
 }else if((_itemid==1)) { 
 //BA.debugLineNum = 107;BA.debugLine="File.Delete(galleryPath,currentPicture.Tag)";
anywheresoftware.b4a.keywords.Common.File.Delete(mostCurrent._gallerypath,BA.ObjectToString(mostCurrent._currentpicture.getTag()));
 //BA.debugLineNum = 108;BA.debugLine="currentPicture.SetBackgroundImage(LoadBitmap(File.DirAssets,\"no_image.jpg\"))";
